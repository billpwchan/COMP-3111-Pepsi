...
public abstract class Chart implements Serializable{
	...
	/**
	 * Data requirement (no. of numeric column or text column) for each type of chart 
	 * @return boolean value to whether the chart passes the data requirement standards
	 */
